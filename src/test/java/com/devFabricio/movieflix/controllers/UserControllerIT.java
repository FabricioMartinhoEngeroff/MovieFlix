...
import com.devFabricio.movieflix.tests.TokenUtil;
...
public class UserControllerIT {
	...
	public void getProfileShouldReturnSelfWhenVisitorLogged() throws Exception {
		...
		ResultActions result = mockMvc.perform(get("/users/profile").header("Authorization", "Bearer " + accessToken)
	...
	public void getProfileShouldReturnUnauthorizedWhenNoUserLogged() throws Exception {
		...
		ResultActions result = mockMvc.perform(get("/users/profile").accept(MediaType.APPLICATION_JSON));
